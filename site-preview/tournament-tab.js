(function () {
  ...
  Object.assign(TEAM_KO_NAME_MAP, {
    arg: "아르헨티나",
    bra: "브라질",
    can: "캐나다",
    col: "콜롬비아",
  ...
  Object.assign(TEAM_KO_NAME_BY_ENGLISH, {
    argentina: "아르헨티나",
    brazil: "브라질",
    canada: "캐나다",
    colombia: "콜롬비아",
  ...
  Object.assign(TEAM_KO_NAME_LOOKUP, {
    south_africa: "남아공",
    "south africa": "남아공",
    za: "남아공",
    zaf: "남아공",
  ...
  Object.assign(TOURNAMENT_KO_NAME_OVERRIDES, {
    south_africa: "남아공",
    za: "남아공",
    zaf: "남아공",
    bosnia_and_herzegovina: "보스니아 헤르체고비나",
  ...
  Object.assign(TOURNAMENT_TEAM_KO_NAME_MAP, {
    south_africa: "남아공",
    zaf: "남아공",
    za: "남아공",
    bosnia_and_herzegovina: "보스니아 헤르체고비나",
  ...
  Object.assign(TEAM_KO_NAME_LOOKUP, {
    ...
    congo_dr: "콩고민주공화국",
    dr_congo: "콩고민주공화국",
    democratic_republic_of_the_congo: "콩고민주공화국",
    cod: "콩고민주공화국",
    panama: "파나마",
    pan: "파나마",
  });
  ...
  function createFullBracketBoard() {
    ...
    leftSide.append(
      ...
      createBoardStageColumn("Quarter Final", [97, 98], displayMap, "is-left"),
    ...
    rightSide.append(
      ...
      createBoardStageColumn("Quarter Final", [99, 100], displayMap, "is-right"),
  ...
  function createMatchCard(match, isFinalRound, sideDisplay) {
    ...
    mobileMatchId.textContent = `M${match.matchNo}`;
  ...
  function createVersusBlock(match) {
    ...
    matchLabel.textContent = `M${match.matchNo}`;
